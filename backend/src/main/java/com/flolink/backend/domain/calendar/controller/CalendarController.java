...
public class CalendarController {
    ...
    public ResponseEntity<?> getCalendarList(@PathVariable("date") Date date, @PathVariable("date") int roomId, Authentication authentication) {
        CustomUserDetails customUserDetails = (CustomUserDetails)authentication.getPrincipal();
        log.info("===캘린더 일정 반환 START===");
        List<CalendarResponse> list = calendarService.getList(date, roomId, customUserDetails.getUserId());
        log.info("===캘린더 일정 반환 START===");
    ...
    public ResponseEntity<?> removeCalendar(@RequestBody DeleteCalendarRequest deleteCalendarRequest, Authentication authentication){
        CustomUserDetails customUserDetails = (CustomUserDetails)authentication.getPrincipal();
    ...
    @PatchMapping("/update")
    public ResponseEntity<?> updateCalendar(@RequestBody UpdateCalendarRequest updateCalendarRequest, Authentication authentication){
        CustomUserDetails customUserDetails = (CustomUserDetails)authentication.getPrincipal();
