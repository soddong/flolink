      ...
      >
        {channelStatus === "선택" && (
          <>
            ...
            <button className={styles.modalButton} style={{background : '#30A9DE' }}onClick={onJoinFamily}>
              가족 입장하기
            </button>
          </>
        )}
        {channelStatus === "생성" && (
          <>
            <h2 className={styles.modalTitle}>가족 만들기</h2>
            <h3>가족방 이름</h3>
            <input
            ...
            ></input>
            <button onClick={handleCreateUserRoom}>만들기</button>
          </>
        )}
        {channelStatus === "추가" && (
          <>
            <h2 className={styles.modalTitle}>가족 입장하기</h2>
            <h3>가족방 번호</h3>
            <input
            ...
            ></input>
            <button onClick={handleRegisterUserRoom}>입장하기</button>
          </>
        )}
      </div>
    </div>
