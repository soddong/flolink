...
import loadingImage from '../assets/logo.png'; // 로고 이미지 경로를 실제 경로로 변경하세요
import waveImage from '../assets/image.png';
import LoadingPageStyle from '../css/Loadingpage.module.css';
