  ...
  <div className="w-full h-full box-border bg-gradient-to-b from-cyan-400 to-sky-50 relative">
    ...
    <div className="p-7 w-full box-border">
      <header className="flex justify-between">
        <h1 className="m-0 font-bold text-2xl text-rose-400">우리는 꿀벌 가족🍯</h1>
      ...
      <div className="w-full h-56 flex justify-center items-center relative">
        ...
        <button className="absolute bottom-0 right-0 rounded-lg bg-rose-400 text-white text-xs font-bold w-24 h-8 z-10">
          함께 산책하기
        </button>
      </div>
